...
INSERT INTO banks (bank_code, bank_name, swift_code, is_active) VALUES
    ...
    ('CIMB', 'Bank CIMB Niaga', 'CMNMIDJA', 1),
    ('DANAMON', 'Bank Danamon', 'DANAIDJA', 1),
    ('OCBC', 'Bank OCBC NISP', 'NIASPIDJA', 1),
    ('MEGA', 'Bank Mega', 'MEGAIDJA', 1),
    ('PERMATA', 'Bank Permata', 'IDIHIDJA', 1),
    ('UOB', 'Bank UOB Indonesia', 'UOBBIDJA', 1),
    ('COMMONWEALTH', 'Bank Commonwealth', 'CBKLIDJA', 1),
    ('PANIN', 'Bank Panin', 'PNBAIDJA', 1),
    ('MAYBANK', 'Maybank Indonesia', 'MAYAIDJA', 1),
    ('BTN', 'Bank BTN', 'BTNIDJA', 1),
    ('SUMITOMO', 'Bank BTMU', 'SUMIIDJA', 1),
    ('DBS', 'DBS Bank', 'DBASISJ', 1),
